...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.slides = [
      { durationInSeconds : 10, htmlValue : this.htmlValue, textBackgroundColor : "orange", mediaSrc : this.imgSrc1, imageMedia : true,  
        mediaTitle : "Example Image1", mediaWidthPercent : 0.7, mediaHeightWidthRatio : 0.5625 },
      { durationInSeconds : 10, htmlValue : this.htmlValue, textBackgroundColor : "purple", mediaSrc : this.imgSrc2, imageMedia : true,  
      mediaTitle : "Example Image2", mediaWidthPercent : 0.7, mediaHeightWidthRatio : 864/1218 },
      { durationInSeconds : 20, htmlValue : this.htmlValue, textBackgroundColor : "brown", mediaSrc : this.videoSrc1, videoMedia : true,  
      mediaTitle : "Example Video1", mediaWidthPercent : 0.7, mediaHeightWidthRatio : 344/425 },
      { durationInSeconds : 20, htmlValue : this.htmlValue, textBackgroundColor : "green", mediaSrc : this.videoSrc2, videoMedia : true,  
